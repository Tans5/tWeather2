...
import com.tans.tweather2.ui.cities.CitiesViewModel
...
abstract class ViewModelModule {
    ...
    @Binds
    @IntoMap
    @ViewModel(CitiesViewModel::class)
    abstract fun bindCitiesViewModel(viewModel: CitiesViewModel): androidx.lifecycle.ViewModel
